...
/*
    - Context object yaratdıq
    - Object-ə Default Value mənimsətdik (başlanğıc dəyər) və Export etdik
    - İstifadə etmək istədiyimiz componentə import etdik
    - static contextType vasitəsi ilə, import etdiyimiz componentdə mənimsətdik (bir js daxilində neçə data saxlanılır?)
    - this.context ilə lazım olan datanı mənimsətdik
*/
...
// 2 - Provider --> Consumer
/*
    - Class component yaratdıq və datanı state içinə qoyduq
    - Context-ə aid Provider ilə State-də olan datanı aldıq
    - Parent child əlaqəsi: {this.props.children}
    - Datanı göndərəcəyimiz component-də Context-i import edirik
    - Render içərisində Consumer ilə Providerdən gələn datanı return edirik
*/